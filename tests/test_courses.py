...
def test_create_course(courses_list_page: CoursesListPage, create_course_page: CreateCoursePage):
    ...
    create_course_page.upload_preview_image('C:/Users/Пользователь/Documents/GitHub/autotests-ui/testdata/files/image.png')
    create_course_page.check_visible_image_upload_view()
    ...
    courses_list_page.check_visible_course_card(index=0, title='Playwright', estimated_time='Playwright', max_score='10', min_score='10')
